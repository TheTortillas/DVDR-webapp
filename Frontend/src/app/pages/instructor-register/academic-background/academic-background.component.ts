...
import { EvidenceDialogComponent } from '../../../components/evidence-dialog/evidence-dialog.component';
...
const ELEMENT_DATA: AcademicBackground[] = [
  { nivelEscolar: 'Licenciatura', periodo: '2010-2014', institucion: 'Universidad X', tituloOtorgado: 'Ingeniero', evidencia: 'Ver' },
...
export class AcademicBackgroundComponent {
  displayedColumns: string[] = ['nivelEscolar', 'periodo', 'institucion', 'tituloOtorgado', 'evidencia'];
